...
import ItemsNonInventory from './ItemsNonInventory';
...
class ItemsList extends React.Component {
  ...
  handleClick(index){
    ...
    if(index === 3)
      this.setState({
        displayPane: "noninventoryitems"
      })
    if(index === 4)
      this.setState({
        displayPane: "stockcards"
      })
  ...
  render(){
    ...
    const renderDefault = () =>{
      ...
      else if(this.state.displayPane === "noninventoryitems")
      return(
        <ItemsNonInventory/>
      );
      else if(this.state.displayPane === "stockcards")
      return(
        <StockCards/>
      );
    ...
    <div className="w3-container" >
      <div className="w3-container w3-teal" >
        ...
        <button onClick={() => this.handleClick(1)} style={{marginLeft: "10px"}}>Items List</button>
      </div>
