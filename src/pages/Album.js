...
w3_close() {
  ...
  render(){
    ...
    return(
      ...
      <div class="w3-light-grey w3-content" style={{maxWidth: "1600px"}}>

{/*<!-- Sidebar/menu -->*/}
 
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style={{zIndex: "3", width: "300px", display: this.state.toggleNavigation}} id="mySidebar">

<br/>
  <div class="w3-container">
    <a href="#" onClick={() => this.w3_close()} class="w3-hide-large w3-right w3-jumbo w3-padding w3-hover-grey" title="close menu">
  ...
  <div class="w3-bar-block">
    <a  href="#portfolio" onClick={() => this.w3_close()} class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>PORTFOLIO</a> 
    <a href="#about" onClick={()=> this.w3_close()} class="w3-bar-item w3-button w3-padding"><i class="fa fa-user fa-fw w3-margin-right"></i>ABOUT</a> 
    <a href="#contact" onClick={() => this.w3_close()} class="w3-bar-item w3-button w3-padding"><i class="fa fa-envelope fa-fw w3-margin-right"></i>CONTACT</a>
  </div>
...
<div class="w3-overlay w3-hide-large w3-animate-opacity" onClick={() => this.w3_close()} style={{cursor: "pointer"}} title="close side menu" id="myOverlay"></div>
